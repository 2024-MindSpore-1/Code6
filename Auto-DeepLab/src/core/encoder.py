...
class NASBaseCell(nn.Cell):
    ...
    def construct(self, prev_prev_input, prev_input):
        ...
        s1 = ops.interpolate(prev_input, (feature_size_h, feature_size_w), None, align_corners=True)
        s0 = ops.interpolate(prev_prev_input, (s1.shape[2], s1.shape[3]), None, align_corners=True)
